module ApplicationHelper
  def get_twitter_card_info(post)
    ...
    if post.present?
      if post.id.present?
        twitter_card[:url] = "https://zngmk.herokuapp.com/posts/#{post.id}"
        ...
        twitter_card[:image] = "https://raw.githubusercontent.com/sato-takuya/zngmk/master/app/assets/images/top.png"
      end
    else
      twitter_card[:url] = 'https://zngmk.herokuapp.com/'
      twitter_card[:image] = "https://raw.githubusercontent.com/sato-takuya/zngmk/master/app/assets/images/top.png"
